...
my_negative_integar = -7         #Integar
my_negative_integar_type = type(my_negative_integar)
print(my_negative_integar_type)

my_large_float = 1.23456789e10   #Float
